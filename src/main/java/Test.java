...
public class Test {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class c = Test.class.getClassLoader().loadClass("java.lang.String");
        System.out.println(c.getClassLoader());
        String s = new String();

        /*try {
            BigDecimal weightFactroy = BigDecimal.valueOf(0.77).divide(BigDecimal.valueOf(1));
            System.out.println(weightFactroy.multiply(BigDecimal.valueOf(1)).doubleValue());
...
//            getWord();
    ...
    public static void getWord() throws Exception {
        ...
        FileOutputStream fos = new FileOutputStream(
                "C:\\Users\\wubo\\Desktop\\bbbb.docx");
        xdoc.write(fos);
        fos.close();
    }
    ...
    private static XWPFTableCell getCellHight(XWPFTable xTable, int rowNomber,
                                              int cellNumber) {
    ...
    // 设置表格间的空行
    public static void setEmptyRow(XWPFDocument xdoc,
    ...
    public static void createSimpleTable(XWPFTable xTable, XWPFDocument xdoc) throws IOException {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            setCellText
                    ...
                    (xdoc, getCellHight(xTable, i, 1), "种类细则" + i);
    ...
    static void mergeCellVertically(XWPFTable table, int col, int fromRow,
        ...
        for (int rowIndex = fromRow; rowIndex <= toRow; rowIndex++) {
            ...
            if (rowIndex == fromRow) {
                ...
                // merged cell is set with RESTART merge value
            ...
            if (tcPr != null) {
                ...
                // only set an new TcPr if there is not one
    ...
    mergeCellHorizontally(XWPFTable table, int row, int fromCol, int toCol) {
        for (int colIndex = fromCol; colIndex <= toCol; colIndex++) {
            CTHMerge hmerge =

                    CTHMerge.Factory.newInstance();
            if (colIndex == fromCol) {
            ...
            XWPFTableCell cell = table.getRow
